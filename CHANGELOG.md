...
### Released
- Published **aeo-sdk-swift** as a public, portfolio-grade answer-engine visibility system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **aeo-sdk-swift**.
...
- That insight became the basis for **aeo-sdk-swift**.
