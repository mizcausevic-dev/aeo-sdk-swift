...
### Released
- Published **aeo-sdk-swift** as a public, portfolio-grade system focused on answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **aeo-sdk-swift** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Swift SDK for the AEO Protocol v0.1. Parse, build, validate, and fetch AEO declaration documents. Foundation-only, async/await fetchWellKnown via URLSession. Completes the AEO SDK family at five languages.
